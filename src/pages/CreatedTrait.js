  ...
  return (
    ...
    <section className='w-[94%] relative h-full bg-gray-light ml-auto py-16'>
          ...
          <div className='w-[85%] ml-auto px-5'>
              <div className='max-w-7xl grid grid-cols-1-5 gap-5 mx-auto relative'>
                <IndividualCreatedTrait 
                    ...
                    clild={(<div>
                      ...
                      <input type='text' className='border border-gray-400 w-full bg-gray-light focus:outline-none p-[2px]' />
                    </div>)}
                    />
